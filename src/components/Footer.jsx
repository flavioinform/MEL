                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:mentorgestiones@gmail.com" className="hover:text-white transition-colors">mentorgestiones@gmail.com</a>
                            </li>
                            <li className="flex items-center gap-3">
                                <Phone className="text-sky-500 w-5 h-5 flex-shrink-0" />
                                <a href="https://wa.me/+56977509209" className="hover:text-white transition-colors">+56 9 7750 9209</a>
                            </li>
                        </ul>
                    </div>
                </div>
